...
import { ExternalLink, Code, CheckCircle, Cpu, ShieldCheck, Layers } from 'lucide-react';
...
const PasswordGenerator = () => {
  ...
  const features = [
    ...
    "High usability for everyday security needs",
    "Zero-data-storage local execution"
  ];

  const techStack = [
    { name: "Frontend", value: "React.js", icon: <Code size={18} /> },
    { name: "Styling", value: "Tailwind CSS", icon: <Layers size={18} /> },
    { name: "Security", value: "Crypto API", icon: <ShieldCheck size={18} /> },
    { name: "Utility", value: "Custom Logic", icon: <Cpu size={18} /> }
  ];
        ...
        <div className="container mx-auto flex justify-center items-center">
          <div className="flex flex-col items-center">
            <h1 className="text-base font-black tracking-[0.2em] text-gray-900 flex items-center gap-2 uppercase">
              ...
              Key<span className="text-primary">Guard</span>
            </h1>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <iframe sandbox="allow-scripts allow-same-origin"
              src="https://password-generator-oppongcoffies-projects.vercel.app"
              title="Password Generator Preview"
            ...
            <motion.div variants={itemVariants} className="">
              <div className="flex justify-between items-center">
                ...
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-5">
                  <motion.a
                    href="https://password-generator-oppongcoffies-projects.vercel.app"
                    target="_blank"
              ...
              <p className="text-xl text-gray-500 leading-relaxed font-medium mb-5">
                A secure and customizable password generation tool built with React. It focuses on security best practices and high usability for everyday security needs.
              </p>
            </motion.div>
