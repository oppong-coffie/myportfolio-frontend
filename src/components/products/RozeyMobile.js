...
const RozeyMobile = () => {
  ...
  const features = [
    "High-end mobile store experience",
    "Seamless product browsing and search",
    "Secure mobile checkout journey",
    "Exclusive mobile-only promotions"
  ];

  const techStack = [
    { name: "Framework", value: "React Native / Expo", icon: <Smartphone size={18} /> },
    { name: "Frontend", value: "React Dashboard", icon: <Code size={18} /> },
    { name: "Styling", value: "Styled Components", icon: <Layers size={18} /> },
    { name: "UX", value: "High Fidelity", icon: <Cpu size={18} /> }
  ];
        ...
        <div className="container mx-auto flex justify-center items-center">
          <div className="flex flex-col items-center">
            <h1 className="text-base font-black tracking-[0.2em] text-gray-900 flex items-center gap-2 uppercase">
              ...
              Rozey<span className="text-primary">Mobile App</span>
            </h1>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <div className="w-full h-full flex items-center justify-center bg-purple-900">
              <Smartphone size={80} className="text-white animate-pulse" />
              <span className="ml-4 text-2xl font-black text-white tracking-widest uppercase">RozeyMobile Preview Coming Soon</span>
            </div>
          </motion.div>
          ...
          >
            <motion.div variants={itemVariants} className="">
              ...
              <p className="text-xl text-gray-500 leading-relaxed font-medium mb-5">
                RozeyMobile is a premium mobile commerce platform designed for high-end retail experiences.
                It prioritizes speed, security, and a seamless user journey for mobile shoppers.
              </p>
            </motion.div>
