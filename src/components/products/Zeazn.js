        ...
        <div className="container mx-auto flex justify-center items-center">
          <div className="flex flex-col items-center">
            <h1 className="text-base font-black tracking-[0.2em] text-gray-900 flex items-center gap-2 uppercase">
              ...
              Zeazn <span className="text-primary">Limited</span>
            </h1>
          ...
          >
            ...
            <motion.div variants={itemVariants} className="max-w-3xl">
              ...
              <p className="text-xl text-gray-500 leading-relaxed font-medium">
                A comprehensive business website for Zeazn Limited, featuring a modern design and responsive layout. 
                The project focused on creating a professional presence that highlights their core services and value proposition.
              </p>
            </motion.div>
