...
const TeamAlfy = () => {
  ...
  const features = [
    "Corporate-grade design excellence",
    "Comprehensive service showcase",
    "Fully responsive portfolio layout",
    "Optimized for conversion and lead gen"
  ];
    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
        ...
        <div className="container mx-auto flex justify-center items-center">
          <div className="flex flex-col items-center">
            <h1 className="text-base font-black tracking-[0.2em] text-gray-900 flex items-center gap-2 uppercase">
              ...
              Team<span className="text-primary">Alfy</span>
            </h1>
      ...
      <main className="py-12 md:py-20 px-6">
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <iframe 
              src="https://team-alfy.vercel.app/" 
              title="TeamAlfy Preview" 
          ...
          >
            ...
            <motion.div variants={itemVariants} className="max-w-3xl">
              ...
              <p className="text-xl text-gray-500 leading-relaxed font-medium">
                Official company website for TeamAlfy, showcasing their services and design portfolio with a focus on corporate design excellence.
              </p>
            </motion.div>
