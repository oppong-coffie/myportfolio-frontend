...
import { ExternalLink, CheckCircle, Code, Cpu, ShieldCheck, Clock, Layers } from 'lucide-react';
...
const TimeTracker = () => {
  ...
  const features = [
    "Productive time tracking dashboard",
    "Detailed analytics with TypeScript support",
    "Day, week, and month activity monitoring",
    "Fully responsive and performant UI"
  ];

  const techStack = [
    { name: "Language", value: "TypeScript", icon: <Code size={18} /> },
    { name: "Framework", value: "React.js", icon: <Cpu size={18} /> },
    { name: "Styling", value: "Tailwind CSS", icon: <Layers size={18} /> },
    { name: "Analytics", value: "Custom Logic", icon: <Clock size={18} /> }
  ];
        ...
        <div className="container mx-auto flex justify-center items-center">
          <div className="flex flex-col items-center">
            <h1 className="text-base font-black tracking-[0.2em] text-gray-900 flex items-center gap-2 uppercase">
              ...
              Time<span className="text-primary">Flow</span>
            </h1>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <iframe sandbox="allow-scripts allow-same-origin"
              src="https://time-tracking-dashboard-ts-sigma.vercel.app"
              title="Time Tracker Preview"
            ...
            <motion.div variants={itemVariants} className="">
              <div className="flex justify-between items-center">
                ...
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-5">
                  <motion.a
                    href="https://time-tracking-dashboard-ts-sigma.vercel.app"
                    target="_blank"
              ...
              <p className="text-xl text-gray-500 leading-relaxed font-medium mb-5">
                A productive time tracking dashboard with detailed analytics and TypeScript support.
                Helps users monitor their activities across day, week, and month views.
              </p>
            </motion.div>
