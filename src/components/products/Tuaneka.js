...
const Tuaneka = () => {
  ...
  const features = [
    "AI-powered interactive user experiences",
    "Tailored for localized African contexts",
    "Optimized LLM bridge for accessibility",
    "Fully responsive and modular AI interface"
  ];

  const techStack = [
    { name: "Frontend", value: "React.js", icon: <Code size={18} /> },
    { name: "Styling", value: "Tailwind CSS", icon: <Layers size={18} /> },
    { name: "AI Core", value: "Large Language Models", icon: <Sparkles size={18} /> },
    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
        ...
        <div className="container mx-auto flex justify-center items-center">
          <div className="flex flex-col items-center">
            <h1 className="text-base font-black tracking-[0.2em] text-gray-900 flex items-center gap-2 uppercase">
              ...
              Tuaneka <span className="text-primary">AI</span>
            </h1>
      ...
      <main className="py-12 md:py-20 px-6">
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <iframe 
              src="https://tuaneka-v1.vercel.app" 
              title="Tuaneka Preview" 
          ...
          >
            ...
            <motion.div variants={itemVariants} className="max-w-3xl">
              ...
              <p className="text-xl text-gray-500 leading-relaxed font-medium">
                An AI-powered application leveraging large language models for interactive user experiences. 
                Designed specifically for localized African contexts to bridge the gap in AI accessibility.
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="pt-10 flex flex-col sm:flex-row gap-5">
              <motion.a 
                href="https://tuaneka-ai-vitereact.vercel.app" 
                target="_blank" 
