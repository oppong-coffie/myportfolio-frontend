...
const ZuluDesk = () => {
  ...
  const features = [
    ...
    "Tailored for business promotions and products",
    "Modern, high-performance architecture",
    "Secure checkout and product management"
  ];

  const techStack = [
    { name: "Framework", value: "Next.js", icon: <Code size={18} /> },
    { name: "Styling", value: "Tailwind CSS", icon: <Layers size={18} /> },
    { name: "React", value: "Server Components", icon: <Cpu size={18} /> },
    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
        ...
        <div className="container mx-auto flex justify-center items-center">
          <div className="flex flex-col items-center">
            <h1 className="text-base font-black tracking-[0.2em] text-gray-900 flex items-center gap-2 uppercase">
              ...
              Zulu<span className="text-primary">Desk</span>
            </h1>
      ...
      <main className="py-12 md:py-20 px-6">
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <iframe 
              src="https://zulupromo.vercel.app" 
              title="ZuluDesk Preview" 
          ...
          >
            ...
            <motion.div variants={itemVariants} className="max-w-3xl">
              ...
              <p className="text-xl text-gray-500 leading-relaxed font-medium">
                An e-commerce platform built with Next.js, providing a seamless shopping experience for business promotions and products.
              </p>
            </motion.div>
