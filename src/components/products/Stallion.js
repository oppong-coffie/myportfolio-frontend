...
import { ExternalLink, CheckCircle, Code, Cpu, ShieldCheck, Zap, Ship, Building2, Layers } from 'lucide-react';
...
const Stallion = () => {
  ...
  const features = [
    ...
    "Multi-vendor coordination portal"
  ];

  const techStack = [
    { name: "Backend", value: "Node.js / Express", icon: <Layers size={18} /> },
    { name: "Database", value: "PostgreSQL / Prisma", icon: <ShieldCheck size={18} /> },
    { name: "Frontend", value: "React Dashboard", icon: <Code size={18} /> },
    { name: "Cloud", value: "AWS Infrastructure", icon: <Zap size={18} /> }
  ];
        ...
        <div className="container mx-auto flex justify-center items-center">
          <div className="flex flex-col items-center">
            <h1 className="text-base font-black tracking-[0.2em] text-gray-900 flex items-center gap-2 uppercase">
              ...
              Stallion <span className="text-primary">Logistics</span>
            </h1>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <div className="w-full h-full flex items-center justify-center bg-amber-900">
               <Ship size={80} className="text-white animate-pulse" />
               <span className="ml-4 text-2xl font-black text-white tracking-widest uppercase">Stallion Preview Coming Soon</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <motion.div variants={itemVariants} className="max-w-3xl">
              ...
              <p className="text-xl text-gray-500 leading-relaxed font-medium">
                Stallion Logistics is an enterprise-grade solution for managing complex supply chains and shipment tracking with real-time accuracy and automated optimization.
              </p>
            </motion.div>
