...
import { ExternalLink, ArrowLeft, Globe, CheckCircle, Code, Cpu, Layers, ShieldCheck, Zap, Building2 } from 'lucide-react';
...
const Ipa = () => {
  ...
  const features = [
    ...
    "Modern, clean aesthetic with high-quality imagery",
    "Performance-optimized assets for fast loading",
    "Secure contact and lead generation forms"
  ];
        ...
        <div className="container mx-auto flex justify-center items-center">
          ...
          <div className="flex flex-col items-center">
            <h1 className="text-base font-black tracking-[0.2em] text-gray-900 flex items-center gap-2 uppercase">
              ...
              IPA <span className="text-primary">Website</span>
            </h1>
    ...
    <span className="text-sm font-bold text-primary tracking-wide">
      IPA GH
              ...
              <p className="text-xl text-gray-500 leading-relaxed font-medium">
                A high-impact web portal for IPAGH NGO, designed to facilitate community engagement, 
                streamline information dissemination, and strengthen advocacy for professional 
                accountants across Ghana.
              </p>
            </motion.div>
