...
const sms = () => {
  ...
  const techStack = [
    ...
    { name: "Messaging", value: "Twilio / Gupshup", icon: <Zap size={18} /> },
    { name: "Backend", value: "Node.js / Express", icon: <Layers size={18} /> },
    { name: "Security", value: "API Auth / JWT", icon: <ShieldCheck size={18} /> }
  ];
        ...
        <div className="container mx-auto flex justify-center items-center">
          <div className="flex flex-col items-center">
            <h1 className="text-base font-black tracking-[0.2em] text-gray-900 flex items-center gap-2 uppercase">
              ...
              SMS <span className="text-primary">Portal</span>
            </h1>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <div className="w-full h-full flex items-center justify-center bg-gray-900">
               <Mail size={80} className="text-primary animate-pulse" />
               <span className="ml-4 text-2xl font-black text-white tracking-widest uppercase">SMS Portal Preview Coming Soon</span>
            </div>
          </motion.div>
          ...
          >
            <motion.div variants={itemVariants} className="max-w-3xl">
              ...
              <p className="text-xl text-gray-500 leading-relaxed font-medium">
                SMS Portal is a high-speed messaging platform designed for bulk communications and automated campaign management with robust API support.
              </p>
            </motion.div>
