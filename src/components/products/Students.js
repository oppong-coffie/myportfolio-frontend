...
const Students = () => {
  ...
  const techStack = [
    { name: "Frontend", value: "React / Next.js", icon: <Code size={18} /> },
    { name: "Backend", value: "PostgreSQL / Prisma", icon: <Layers size={18} /> },
    { name: "Auth", value: "NextAuth.js", icon: <ShieldCheck size={18} /> },
    { name: "Styling", value: "Tailwind CSS", icon: <Zap size={18} /> }
  ];
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <div className="w-full h-full flex items-center justify-center bg-blue-900">
               <GraduationCap size={80} className="text-white animate-pulse" />
               <span className="ml-4 text-2xl font-black text-white tracking-widest uppercase">StudentHub Preview Coming Soon</span>
            </div>
          </motion.div>
          ...
          >
            <motion.div variants={itemVariants} className="max-w-3xl">
              ...
              <p className="text-xl text-gray-500 leading-relaxed font-medium">
                StudentHub is a modern educational management system designed to streamline school operations and enhance the learning experience for students, teachers, and parents.
              </p>
            </motion.div>
