        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <div className="w-full h-full flex items-center justify-center bg-slate-900">
               <Gamepad2 size={80} className="text-primary animate-bounce" />
               <span className="ml-4 text-2xl font-black text-white tracking-widest uppercase">GuduGames Preview Coming Soon</span>
            </div>
          </motion.div>
